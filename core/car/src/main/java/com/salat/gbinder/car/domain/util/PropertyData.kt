...
fun getAllProperty(): List<PropertyData> = listOf(
    ...
    PropertyData(
        ...
        key = "BCM_FUNC_WINDOW",
        value = 553844992,
        description = "车窗升降器指令(开/关/暂停/百分比)。",
        possibleValues = mapOf(
    ...
    PropertyData(
        ...
        key = "CAR_MODULE_LAMP",
        value = 721420288,
        description = "选择外部灯光模式(关闭/示宽灯/近光/自动/AHBC)。",
        possibleValues = mapOf(
    ...
    PropertyData(
        ...
        value = 605357056,
        description = "输出到外部负载的能量(V2L/V2V)。",
        possibleValues = emptyMap()
    ),
    PropertyData(
    ...
    PropertyData(
        ...
        value = 570625536,
        description = "自定义配置:Start/Stop系统。",
        possibleValues = emptyMap()
    ),
    PropertyData(
    ...
    PropertyData(
        ...
        value = 620823552,
        description = "轮胎压力单位(kPa/bar/psi)。",
        possibleValues = mapOf(
    ...
    PropertyData(
        ...
        value = 268894976,
        description = "吹风方向模式(Focus/Avoid/Custom)。",
        possibleValues = mapOf(
    ...
    PropertyData(
        ...
        value = 1052161,
        description = "Highway Assist功能配置。",
        possibleValues = mapOf(
    ...
    PropertyData(
        ...
        value = 705168896,
        description = "氛围灯控制模式(颜色/音乐/屏幕/时间)。",
        possibleValues = mapOf(
    ...
    PropertyData(
        ...
        value = 537461504,
        description = "倒车时自动下翻乘客后视镜,以便更好地看到路缘/标线。",
        possibleValues = mapOf(
